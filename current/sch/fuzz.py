...
(' CENTRAL SCHOOL DISTRICT', 'www.yorktown.org', (41.2948292175, -73.8018078166))
]
...
for i in new_l:
    ...
    dup_n = dup_checker_f(i[1])
    if not dup_n: continue
    
    for ii in old_l:
        dup_o = dup_checker_f(ii)

        if ii in dup_n:
            good_rat = [100, ii, dup_n]
            break
        else:
            ...
            rat = fuzz.partial_ratio(o_st, n_st)
            if rat > good_rat[0]:
                good_rat = [rat, o_st, n_st]
