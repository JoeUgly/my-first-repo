...
# Desc: This checks the new list and outputs any items that are missing an element. eg: em url, homepage url, or coords
...
count_em, count_url, count_coords = (0,)*3
...
print('\n missing em, url, coords:',count_em, count_url, count_coords)
