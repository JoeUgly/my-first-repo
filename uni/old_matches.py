...
('Cornell Un Inst Res Dev', 'http://', (42.4454850661, -76.5180349008)),
...
('New York State College of Agriculture And Life Sciences at Cornell', 'http://https://cals.cornell.edu/', (42.4470150296, -76.4823949559)),
('New York State College of Human Ecology at Cornell University', 'http://www.human.cornell.edu', (42.4470150296, -76.4823949559)),
('New York State College of Veterinary Medicine at Cornell University', 'http://https://www.vet.cornell.edu/', (42.4470150296, -76.4823949559)),
...
('North Country Community College-Elizabethtown Campus', 'http://', (44.2071799834, -73.6125850881)),
...
('State University College of Oswego - Metro Center', 'http://https://www.oswego.edu/syracuse/', (43.05026807, -76.15269074)),
...
('State University of New York College at Brockport', 'http://https://www.brockport.edu', (43.20995983, -77.95214253)),
...
for i in new_l:
    ...
    new_dup = dup_checker_f(i[1])
    
    for ii in old_l:

        old_dup = dup_checker_f(ii)

        if new_dup in old_dup:

            if not old_dup or not new_dup: continue
